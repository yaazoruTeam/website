...
function sanitize(monthlyPaymentManagement: Model): Model {
  ...
  const newMonthlyPaymentManagement: Model = {
    ...
    monthlyPayment: MonthlyPayment.sanitize(
      monthlyPaymentManagement.monthlyPayment,
      false,
    ),
    creditDetails: CreditDetails.sanitize(
      monthlyPaymentManagement.creditDetails,
      false,
    ),
    paymentCreditLink: PaymentCreditLink.sanitize(
      monthlyPaymentManagement.paymentCreditLink,
      false,
    ),
