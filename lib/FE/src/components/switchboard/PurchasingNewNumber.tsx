        ...
        <Box>
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{ my: '10px' }}>
                            <CustomSelect
                                ...
                                label={t("target")}
                                options={[
                                    { label: '053-3198756', icon: <img src={israelIcon} alt="" style={{ width: '20px', height: '15px' }} />, value: '053-3198756' },
                                    { label: '053-3187542', icon: <img src={usaIcon} alt="" style={{ width: '20px', height: '15px' }} />, value: '053-3187542' },
                                    { label: '052-7854120', icon: <img src={englandIcon} alt="" style={{ width: '20px', height: '15px' }} />, value: '052-7854120' },
                                ]}
                            />
                        </Box>
                        <Box sx={{ my: '10px' }}>
            ...
            <CustomModal open={open} onClose={onClose} maxWidth="520px" padding="32px" >
                <Box sx={{
                    ...
                    <Box sx={{ my: '32px' }}>
                        {numbers.map((item, index) => (
                            <Box key={index} >
                                ...
                                }]} value={selectedPrice} onChange={setSelectedPrice} />
                            </Box>
                        ))}
                    ...
                    {(errorNotSelectedNumber && !selectedPrice) && <Box>
                        <CustomTypography
