    ...
    >
      ...
      <CustomTabs
        tabs={[{
          ...
          content: <EditNumberForm value={formData.editNumber} onChange={(data) => handleFormChange('editNumber', data)} />
        },
        {
          label: t('speedDial'),
          content: <EditingContacts value={Array.isArray(formData.speedDial) ? formData.speedDial : []} onChange={(data) => handleFormChange('speedDial', data)} />
        }]}
