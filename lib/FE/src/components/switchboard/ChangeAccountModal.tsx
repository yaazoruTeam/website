...
const ChangeAccountModal: React.FC<ChangeAccountModalProps> = ({ open, onClose }) => {
  ...
  return (
    <CustomModal open={open} onClose={onClose}>
      ...
      >
        ...
        >
          <CustomTypography text={t('switchAccount')} variant='h1' weight='medium' />
        </Box>
        <Box
          sx={{
            width: '100%',
        ...
        >
          <CustomButton label={t('deletion')} buttonType='third' state='active' onClick={onClose} />
          <CustomButton label={t('replace')} buttonType='second' state='default' />
        </Box>
      </Box>
    </CustomModal>
  )
