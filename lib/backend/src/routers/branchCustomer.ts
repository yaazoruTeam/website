...
branchCustomerRouter.get('/branch/:id', hasRole('admin'), branchCustomerController.getBranchCustomerByBranch_id);
branchCustomerRouter.get('/customer/:id', hasRole('admin'), branchCustomerController.getBranchCustomerByCustomer_id);
