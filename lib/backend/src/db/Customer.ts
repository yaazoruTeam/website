import { DatabaseTransaction, QueryBuilder } from "../types/database"
...
const createCustomer = async (customer: Customer.Model, trx?: DatabaseTransaction) => {
...
const searchCustomersByName = async (
  ...
  try {
    ...
    const buildWhereClause = (query: QueryBuilder) => {
      terms.forEach((term) => {
