...
import { KnexTransaction, KnexQueryBuilder, WhereClauseBuilder } from '../types'
import getDbConnection from '@db/connection'
import config from '@config/index'

const limit = config.database.limit

const createCustomer = async (customer: Customer.Model, trx?: KnexTransaction) => {
...
const searchCustomersByName = async (
  ...
  try {
    ...
    const buildWhereClause = (query: KnexQueryBuilder) => {
      terms.forEach((term) => {
        query.andWhere((qb: KnexQueryBuilder) => {
