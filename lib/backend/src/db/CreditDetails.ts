import { CreditDetails, HttpError, DatabaseTypes } from '@model'
import getDbConnection from '@db/connection'
import config from '@config/index'

const limit = config.database.limit

const createCreditDetails = async (creditDetails: CreditDetails.Model, trx?: DatabaseTypes.Transaction) => {
