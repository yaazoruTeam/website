import { HttpError, MonthlyPayment , DatabaseTypes} from '@model'
import getDbConnection from '@db/connection'
import config from '@config/index'

const limit = config.database.limit

const createMonthlyPayment = async (monthlyPayment: MonthlyPayment.Model, trx?: DatabaseTypes.Transaction) => {
