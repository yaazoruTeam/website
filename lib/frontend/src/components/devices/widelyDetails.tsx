...
import { getPackagesWithInfo, getWidelyDetails, terminateLine, resetVoicemailPincode, changePackages, sendApn, ComprehensiveResetDevice, freezeUnfreezeMobile, lockUnlockImei } from '../../api/widely'
