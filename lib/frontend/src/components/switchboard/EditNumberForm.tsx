...
const EditNumberForm: React.FC<{ value: EditNumberFormInputs; onChange: (data: EditNumberFormInputs) => void }> = ({
  value,
  onChange,
}) => {
  ...
  return (
    <Box>
      {settingPersonalID && (
        <SettingPersonalID
          open={settingPersonalID}
          onClose={() => setSettingPersonalID(!settingPersonalID)}
        />
      )}
      <Box>
        <Box
        ...
        >
          ...
          >
            ...
            <CustomTypography text={t('settingPersonalID')} weight='regular' variant='h4' />
          </Box>
        </Box>
        <Box
          sx={{
